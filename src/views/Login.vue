<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <b class="text-4xl text-at-blue mb-4 text-center">Login</b>
    ...
    <div class="flex flex-col mb-2">
      ...
      v-model="password"
      /> 
      <label for="email" class="mb-1 text-m text-at-blue self-end">Forget Password?</label>
    </div>
    ...
    <router-link class="text-l mt-6 text-center text-at-blue" :to="{name: 'Register'}">
      Don't have an account? Please <span class="text-at-dark-blue">Register</span>
    </router-link>
    </form>
  </div>
</template>
